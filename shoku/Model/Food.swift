...
var foods = [
    Food (title: "Choclate Cake", description: "チョコレートケーキ（英語: Chocolate cake）は、チョコレートまたはココアパウダーを主要材料に含むケーキである。ケーキの生地にココアパウダーを混ぜて焼くのが基本で、さらにチョコレートクリームを塗ったもの", price: "200", image:"choclates"),
